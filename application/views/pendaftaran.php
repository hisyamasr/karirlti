	...
	$(document).ready(function() {
		...
		$('#submitForm').click(function() {
			...
			$.ajax({
				...
				success: function(result) {
					if (result.status == true) {
						$.redirect('<?= base_url(); ?>pendaftaran/success', {
							'data': result.dataPelamar
						});
						//console.log(result.errorList);
					} else if (result.status == false) {
					...
					<div class="card-body row">
						...
						<div class="col-md-12 row ml-1">
							...
							<div class="form-group col-md-1">
								...
								<input class="form-control" type="number" id="IPK">
					...
					<div class="card-body">
						<div class="form-group col-md-8">
							...
							<span class="form-text text-white">
								*CV dalam format <b>.pdf</b> dengan ukuran <b>
									<= 2 MB</b> serta dilengkapi dengan <b>Transkrip Nilai
								</b> dan <b>Ijazah</b>
							</span>
						...
						<div class="form-group col-md-5">
							...
							<span class="form-text text-white">
								*Foto dalam format <b>.jpg</b> atau <b>.png</b> dengan ukuran <b>
									<= 1 MB</b> </span> </div> <img id="ImageUploaded" height="130" width="90" src="" alt="" />
